...
public class Controls implements Disposable {
    ...
    public Controls(SpriteBatch sb) {
        ...
        Image leftButton = new Image(new Texture("left_28x28.png"));
        ...
        Image rightButton = new Image(new Texture("right_28x28.png"));
        ...
        Image jumpButton = new Image(new Texture("jump_28x28.png"));
        ...
        float spacer = (LearnLibgdxBox2d.V_WIDTH - leftButton.getWidth() - rightButton.getWidth() - jumpButton.getWidth()) / 18;
